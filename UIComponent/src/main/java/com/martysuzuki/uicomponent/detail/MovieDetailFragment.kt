...
import com.martysuzuki.uicomponent.util.ArgsGetter
import com.martysuzuki.viewmodelinterface.detail.MovieDetailUiLogic
import com.martysuzuki.viewmodelinterface.detail.MovieDetailViewModel
...
@AndroidEntryPoint
class MovieDetailFragment : Fragment(), ArgsGetter<MovieDetailArgs> {

    // This property is only valid between onCreateView and
    // onDestroyView.
    private var binding: FragmentMovieDetailBinding? = null

    private val args: MovieDetailArgs by args(this)

    @Inject lateinit var router: MovieDetailRouter

    @Inject lateinit var movieDetailViewModelFactory: MovieDetailViewModel.Factory
    private val viewModel: MovieDetailViewModel by viewModels {
        MovieDetailViewModel.provideFactory(movieDetailViewModelFactory, args.movieId)
    }
